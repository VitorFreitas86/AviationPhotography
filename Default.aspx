<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="sweptwings.Default1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <asp:Panel ID="Panel1" runat="server">
            <asp:DataList ID="DataList1" runat="server" Font-Size="8pt" RepeatDirection="Vertical" CellPadding="15" DataKeyField="idregisto" RepeatColumns="5">
                <ItemTemplate>
             ...
             <%--           <table>
                            <tr>
                                ...
                                <td>
                                    <asp:HyperLink ID="HyperLink_aircraft" Width="185px" NavigateUrl='<%# String.Format("~/list/{0}/{1}","aircraft",Eval("aircraft_url"))%>' runat="server" Text='<%# Bind("aircraft") %>' Target="_blank" Style="text-decoration: none; color: black;" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:HyperLink ID="HyperLink_airline" Width="185px" NavigateUrl='<%# String.Format("~/list/{0}/{1}","airline",Eval("airline_url"))%>' runat="server" Text='<%# Bind("airline") %>' Target="_blank" Style="text-decoration: none; color: black;" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:HyperLink ID="HyperLink_reg" Width="185px" NavigateUrl='<%# String.Format("~/list/{0}/{1}","reg",Eval("reg_url"))%>' runat="server" Text='<%# Bind("reg") %>' Target="_blank" Style="text-decoration: none; color: black;" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:HyperLink ID="HyperLink_msn" Width="185px" NavigateUrl='<%# String.Format("~/list/{0}/{1}","msn",Eval("msn_url"))%>' runat="server" Text='<%# Bind("msn") %>' Target="_blank" Style="text-decoration: none; color: black;" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:HyperLink ID="HyperLink_airport" Width="185px" NavigateUrl='<%# String.Format("~/list/{0}/{1}","airport",Eval("airport_url"))%>' runat="server" Text='<%# Bind("airport") %>' Target="_blank" Style="text-decoration: none; color: black;" />
                                </td>
                            </tr>
                            <tr>
                                <td>
    ...
    <div id="divOne">
        <table cellpadding="0" border="0" id="tblOne" style="color: WhiteSmoke; font-size: 10pt;">
            <tr>
                ...
                <td align="left">&nbsp;&nbsp;<asp:LinkButton ID="lbtnNext" runat="server" CssClass="button-link" CausesValidation="false"
